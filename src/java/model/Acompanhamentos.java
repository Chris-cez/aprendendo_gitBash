...
public class Acompanhamentos implements Serializable {
    ...
    public Acompanhamentos(Integer idacompanhamentos, String nomeaconpanhamento) {
        this.idacompanhamentos = idacompanhamentos;
    ...
    public boolean equals(Object object) {
        ...
        if ((this.idacompanhamentos == null && other.idacompanhamentos != null) || (this.idacompanhamentos != null && !this.idacompanhamentos.equals(other.idacompanhamentos))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "model.Acompanhamentos[ idacompanhamentos=" + idacompanhamentos + " ]";
    }
